      ...
      <div className="lg:hidden">
        ...
        <div className="px-6 sm:px-8 py-8 sm:py-10 flex flex-col gap-4 sm:gap-6">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="https://www.grannex.com"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white text-primary font-medium px-6 py-3 rounded-full hover:bg-green-light transition-colors"
            >
              Visit Grannex.com
