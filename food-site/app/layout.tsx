...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://www.grannexretail.com'),
...
const organizationSchema = {
  ...
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://www.grannexretail.com',
  logo: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.grannexretail.com'}/grannexLogo.svg`,
  contactPoint: {
    '@type': 'ContactPoint',
